...
class CellBuffer:
    @typing.overload
    def add_particle(self, pos: glm.vec2, vel: glm.vec2, color: Color) -> bool:
        ...
    @typing.overload
    def add_particle(self, pos: glm.vec2, vel: glm.vec2, r: typing.SupportsInt, g: typing.SupportsInt, b: typing.SupportsInt, mat_id: typing.SupportsInt, on_fire: bool = False, is_static: bool = False) -> bool:
        ...
    def apply_brush(self, pixel_x: typing.SupportsInt, pixel_y: typing.SupportsInt, radius: typing.SupportsInt, color: Color) -> None:
        ...
    def apply_particle_brush(self, pixel_x: typing.SupportsInt, pixel_y: typing.SupportsInt, radius: typing.SupportsInt, spawn_count: typing.SupportsInt, color: Color) -> None:
        ...
    def clear(self, color: Color) -> None:
        ...
    def get_active_pixel(self, x: typing.SupportsInt, y: typing.SupportsInt) -> Color:
        ...
    def get_back_pixel(self, x: typing.SupportsInt, y: typing.SupportsInt) -> Color:
        ...
    def get_cell_scale(self) -> float:
        ...
    def set_cell_scale(self, value: typing.SupportsFloat) -> None:
        ...
    def get_height(self) -> int:
        ...
    def get_render_texture(self) -> int:
        ...
    def get_width(self) -> int:
        ...
    def initialize_compute(self) -> None:
        ...
    def pixel_to_world(self, pixel_x: typing.SupportsInt, pixel_y: typing.SupportsInt) -> glm.vec2:
        ...
    @typing.overload
    def set_active_pixel(self, x: typing.SupportsInt, y: typing.SupportsInt, color: Color) -> None:
        ...
    @typing.overload
    def set_active_pixel(self, x: typing.SupportsInt, y: typing.SupportsInt, r: str, g: str, b: str, mat_id: typing.SupportsInt, on_fire: bool = False, is_static: bool = False) -> None:
        ...
    @typing.overload
    def set_active_pixel(self, pos: glm.vec2, r: typing.SupportsInt, g: typing.SupportsInt, b: typing.SupportsInt, mat_id: typing.SupportsInt, on_fire: bool = False, is_static: bool = False) -> None:
        ...
    ...
    def update_texture(self) -> None:
        ...
    def window_to_pixel(self, window_x: typing.SupportsInt, window_y: typing.SupportsInt, window_width: typing.SupportsInt, window_height: typing.SupportsInt) -> tuple:
        ...
    def world_to_pixel(self, world_pos: glm.vec2) -> tuple:
        ...
class Collider:
...
class Color:
    ...
    def mat_id(self) -> int:
        ...
    @mat_id.setter
    def mat_id(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def on_fire(self) -> int:
        ...
    @on_fire.setter
    def on_fire(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def r(self) -> int:
        ...
...
class Engine:
    ...
    def set_resolution(self, width: typing.SupportsInt, height: typing.SupportsInt) -> None:
        ...
    def set_viewport(self, x: typing.SupportsInt, y: typing.SupportsInt, width: typing.SupportsInt, height: typing.SupportsInt) -> None:
        ...
...
class Frame:
    @typing.overload
    def __init__(self, engine: Engine, width: typing.SupportsInt = 800, height: typing.SupportsInt = 800) -> None:
        ...
    @typing.overload
    def __init__(self, engine: Engine, shader: Shader, width: typing.SupportsInt = 800, height: typing.SupportsInt = 800) -> None:
        ...
    ...
    def render(self, x: typing.SupportsInt, y: typing.SupportsInt, width: typing.SupportsInt, height: typing.SupportsInt) -> None:
        ...
    @typing.overload
    def render(self, texture_id: typing.SupportsInt) -> None:
        ...
    @typing.overload
    def render(self, texture_id: typing.SupportsInt, x: typing.SupportsInt, y: typing.SupportsInt, width: typing.SupportsInt, height: typing.SupportsInt) -> None:
        ...
    def set_filter_linear(self) -> None:
        ...
    def set_filter_nearest(self) -> None:
        ...
    def use(self) -> None:
        ...
class GpuBuffer:
...
class Light:
    ...
    def set_intensity(self, intensity: typing.SupportsFloat) -> None:
        ...
class Material:
    def __init__(self, color: typing.Any = None, albedo: Image = None, normal: Image = None, alpha: typing.SupportsFloat = 1.0, subsurface: typing.SupportsFloat = 0.0, sheen: typing.SupportsFloat = 0.0, sheen_tint: typing.SupportsFloat = 0.0, anisotropic: typing.SupportsFloat = 0.0, specular: typing.SupportsFloat = 0.75, metallicness: typing.SupportsFloat = 0.0, clearcoat: typing.SupportsFloat = 0.0, clearcoat_gloss: typing.SupportsFloat = 0.0) -> None:
        ...
    def get_albedo(self) -> Image:
        ...
    def get_alpha(self) -> float:
        ...
    def get_anisotropic(self) -> float:
        ...
    ...
    def get_color(self) -> glm.vec3:
        ...
    def get_metallicness(self) -> float:
        ...
    def get_normal(self) -> Image:
        ...
    def get_roughness(self) -> float:
        ...
    def get_sheen(self) -> float:
        ...
    def get_sheen_tint(self) -> float:
        ...
    def get_specular(self) -> float:
        ...
    def get_subsurface(self) -> float:
        ...
    @typing.overload
    def set_albedo(self, albedo: Image) -> None:
        ...
    @typing.overload
    def set_albedo(self, albedo: Image) -> None:
        ...
    def set_alpha(self, alpha: typing.SupportsFloat) -> None:
        ...
    def set_anisotropic(self, anisotropic: typing.SupportsFloat) -> None:
        ...
    def set_clearcoat(self, clearcoat: typing.SupportsFloat) -> None:
        ...
    def set_clearcoat_gloss(self, clearcoat_gloss: typing.SupportsFloat) -> None:
        ...
    def set_color(self, color: glm.vec3) -> None:
        ...
    def set_metallicness(self, metallicness: typing.SupportsFloat) -> None:
        ...
    @typing.overload
    def set_normal(self, normal: Image) -> None:
        ...
    @typing.overload
    def set_normal(self, normal: Image) -> None:
        ...
    def set_roughness(self, roughness: typing.SupportsFloat) -> None:
        ...
    def set_sheen(self, sheen: typing.SupportsFloat) -> None:
        ...
    def set_sheen_tint(self, sheen_tint: typing.SupportsFloat) -> None:
        ...
    def set_specular(self, specular: typing.SupportsFloat) -> None:
        ...
    def set_subsurface(self, subsurface: typing.SupportsFloat) -> None:
        ...
class Mesh:
    @typing.overload
    def __init__(self, modelPath: str, generateUV: bool = False, generateNormals: bool = False) -> None:
        ...
    @typing.overload
    def __init__(self, vertices: collections.abc.Sequence[typing.SupportsFloat]) -> None:
        ...
    @typing.overload
    def __init__(self, vertices: collections.abc.Sequence[typing.SupportsFloat], indices: collections.abc.Sequence[typing.SupportsInt]) -> None:
        ...
...
class Node:
    @typing.overload
    def __init__(self, scene: ..., mesh: typing.Any = None, material: typing.Any = None, position: glm.vec3 = (0.0, 0.0, 0.0), rotation: glm.quat = (1.0, 0.0, 0.0, 0.0), scale: glm.vec3 = (1.0, 1.0, 1.0)) -> None:
        ...
    @typing.overload
    def __init__(self, parent: Node, mesh: typing.Any = None, material: typing.Any = None, position: glm.vec3 = (0.0, 0.0, 0.0), rotation: glm.quat = (1.0, 0.0, 0.0, 0.0), scale: glm.vec3 = (1.0, 1.0, 1.0)) -> None:
        ...
    @typing.overload
    def __init__(self, scene: ...) -> None:
        ...
    @typing.overload
    def __init__(self, mesh: typing.Any = None, material: typing.Any = None, position: glm.vec3 = (0.0, 0.0, 0.0), rotation: glm.quat = (1.0, 0.0, 0.0, 0.0), scale: glm.vec3 = (1.0, 1.0, 1.0)) -> None:
        ...
    ...
    def set_position(self, position: glm.vec3) -> None:
        ...
    def set_rotation(self, rotation: typing.Any) -> None:
        ...
...
class Node2D:
    has_gravity: bool
    @typing.overload
    def __init__(self, scene: Scene2D, mesh: typing.Any, material: typing.Any, position: glm.vec2 = (0.0, 0.0), rotation: typing.SupportsFloat = 0.0, scale: glm.vec2 = (1.0, 1.0), velocity: glm.vec3 = (0.0, 0.0, 0.0), collider: ... = None, density: typing.SupportsFloat = 1.0, friction: typing.SupportsFloat = 0.5) -> None:
        ...
    @typing.overload
    def __init__(self, parent: Node2D, mesh: typing.Any, material: typing.Any, position: glm.vec2 = (0.0, 0.0), rotation: typing.SupportsFloat = 0.0, scale: glm.vec2 = (1.0, 1.0), velocity: glm.vec3 = (0.0, 0.0, 0.0), collider: ... = None, density: typing.SupportsFloat = 1.0, friction: typing.SupportsFloat = 0.5) -> None:
        ...
    @typing.overload
    def __init__(self, scene: Scene2D) -> None:
        ...
    @typing.overload
    def __init__(self, mesh: typing.Any = None, material: typing.Any = None, position: glm.vec2 = (0.0, 0.0), rotation: typing.SupportsFloat = 0.0, scale: glm.vec2 = (1.0, 1.0), velocity: glm.vec3 = (0.0, 0.0, 0.0), collider: ... = None, density: typing.SupportsFloat = 1.0, friction: typing.SupportsFloat = 0.5) -> None:
        ...
    ...
    def get_position(self) -> glm.vec2:
        ...
    def get_resolves_collisions(self) -> bool:
        ...
    def get_rigid(self) -> ...:
        ...
    ...
    def just_collided(self, other: Node2D) -> bool:
        ...
    def orphan_copy(self) -> Node2D:
        """
        Returns an orphaned copy of this node (no rigid, only physics properties)
        """
    ...
    def set_friction(self, friction: typing.SupportsFloat) -> None:
        ...
    def set_has_gravity(self, has_gravity: bool) -> None:
        ...
    def set_jacobian_mask(self, jacobian_mask: glm.vec3) -> None:
        ...
    ...
    def set_position(self, position: glm.vec3) -> None:
        ...
    def set_resolves_collisions(self, resolves_collisions: bool) -> None:
        ...
    ...
    def collision_group(self, arg1: typing.SupportsInt) -> None:
        ...
    @property
...
class Scene:
    ...
    def __init__(self, engine: Engine, addSkybox: bool = True, addLight: bool = True, addCube: bool = False) -> None:
        ...
    @typing.overload
    def __init__(self, engine: Engine, shader: Shader, addSkybox: bool = True, addLight: bool = True, addCube: bool = False) -> None:
        ...
    @typing.overload
...
class Shader:
    ...
    def set_uniform(self, name: str, value: glm.vec3) -> None:
        ...
    @typing.overload
    def set_uniform(self, name: str, value: glm.vec2) -> None:
        ...
    def use(self) -> None:
        ...
class Skybox:
...
class Texture:
    ...
    def get_width(self) -> int:
        ...
    def set_filter(self, mag_filter: typing.SupportsInt, min_filter: typing.SupportsInt) -> None:
        ...
    def set_wrap(self, wrap: typing.SupportsInt) -> None:
        ...
class UBO:
    @typing.overload
