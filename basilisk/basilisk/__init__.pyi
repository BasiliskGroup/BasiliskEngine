...
class Node2D:
    ...
    def __init__(self, scene: ...) -> None:
        ...
    @typing.overload
    def __init__(self, mesh: Mesh, material: Material, position: glm.vec2, rotation: typing.SupportsFloat, scale: glm.vec2, velocity: glm.vec3, collider: ..., density: typing.SupportsFloat, friction: typing.SupportsFloat) -> None:
        ...
