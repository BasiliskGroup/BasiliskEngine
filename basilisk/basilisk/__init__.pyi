...
class Light:
    ...
    def set_intensity(self, intensity: typing.SupportsFloat) -> None:
        ...
class Material:
    def __init__(self, color: glm.vec3 = (1.0, 1.0, 1.0), albedo: Image = None, normal: Image = None, alpha: typing.SupportsFloat = 1.0, subsurface: typing.SupportsFloat = 0.0, sheen: typing.SupportsFloat = 0.0, sheen_tint: typing.SupportsFloat = 0.0, anisotropic: typing.SupportsFloat = 0.0, specular: typing.SupportsFloat = 0.75, metallicness: typing.SupportsFloat = 0.0, clearcoat: typing.SupportsFloat = 0.0, clearcoat_gloss: typing.SupportsFloat = 0.0) -> None:
        ...
