...
from scripts.particles.particle_emitter import ParticleEmitterHandler
#import cudart
...
class ParticleHandler:
    def __init__(self, scene) -> None:
        ...
        self.ico_vbo = scene.vao_handler.vbo_handler.vbos['ico']
        ...
        self.instance_buffer_2d = self.ctx.buffer(reserve=(14 * 3) * (self.particle_cube_size ** 3))
        self.instance_buffer_3d = self.ctx.buffer(reserve=(14 * 3) * (self.particle_cube_size ** 3))
        ...
        self.vao_3d = self.ctx.vertex_array(self.programs['particle3d'], [(self.ico_vbo.vbo, '3f 2f 3f 3f 3f', *['in_position', 'in_uv', 'in_normal', 'in_tangent', 'in_bitangent']), 
